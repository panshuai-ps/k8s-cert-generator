...
func GenerateCert(altNames []string, hostIP, hostName, serviceCIRD, DNSDomain string) error {
    certConfig, err := NewCertMetaData(altNames, serviceCIRD, hostName, hostIP, DNSDomain)
    if err != nil {
